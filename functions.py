...
# ==============================================
# 🚀 LISTA DE SERVICIOS Y PRECIOS FINALES
# ==============================================

# 📸 INSTAGRAM
INSTAGRAM = {
    "👥 Seguidores Brasil 🇧🇷 [100% Reales]":        ["👥 SEGUIDORES BR",         "1.000", 6.99, "ig_follow", 8686],
    "❤️ Likes Mundo [Max 30K] Real":                 ["❤️ LIKES MUNDO REAL",     "1.000", 2.49, "ig_likes", 17858],
    "❤️ Likes Mundo [Max 100K] HQ":                  ["❤️ LIKES MUNDO HQ",       "1.000", 1.99, "ig_likes", 17859],
    "👁️ Vistas Historias [Max 200K]":                ["👁️ VISTAS HISTORIAS",     "1.000", 1.49, "ig_stories", 17860],
    "🔗 Compartidos Publicación [Max 200K]":         ["🔗 COMPARTIDOS",          "1.000", 2.99, "ig_shares", 17861],
    "👁️ Vistas Publicaciones [Max 200K]":            ["👁️ VISTAS POST",          "1.000", 1.20, "ig_views", 17862],
    "❤️ Likes + Impresiones Ruso 🇷🇺":                ["❤️ LIKES + VISTAS RU",    "1.000", 2.49, "ig_mix", 17863],
    "❤️ Likes + Impresiones Ruso HQ":                ["❤️ LIKES + VISTAS RU HQ", "1.000", 2.99, "ig_mix", 17864],
    "❤️ Likes + Impresiones Hombre 🇷🇺":              ["❤️ LIKES HOMBRES RU",     "1.000", 3.49, "ig_mix", 17865]
}

# 🎵 TIKTOK
TIKTOK = {
    "👥 Seguidores Reales [Max 50K]":                ["👥 SEGUIDORES REALES",    "1.000", 5.99, "ttk_follow", 17776],
    "👥 Seguidores Reales 30 Días":                  ["👥 SEGUIDORES 30 DÍAS",   "1.000", 7.99, "ttk_follow", 17777],
    "👥 Seguidores Rápidos [Max 1M]":                ["👥 SEGUIDORES RÁPIDOS",   "1.000", 4.99, "ttk_follow", 13083],
    "👥 Seguidores Calidad [Max 100K]":              ["👥 SEGUIDORES CALIDAD",   "1.000", 5.49, "ttk_follow", 17804],
    "👥 Seguidores Premium [Max 10M]":               ["👥 SEGUIDORES PREMIUM",   "1.000", 8.99, "ttk_follow", 10259],
    "👥 Seguidores Calidad Media [Max 100K]":        ["👥 SEGUIDORES ECONÓMICOS","1.000", 3.99, "ttk_follow", 16320],
    "👥 Seguidores Cuentas Antiguas [Max 1M]":       ["👥 SEGUIDORES ANTIGUOS",  "1.000", 6.49, "ttk_follow", 17572],
    "👥 Seguidores HQ Bajo Drop [Max 50K]":          ["👥 SEGUIDORES HQ",        "1.000", 6.99, "ttk_follow", 15395],
    "👥 Seguidores HQ 30 Días [Max 50K]":           ["👥 SEGUIDORES HQ GARANTÍA","1.000",8.99,"ttk_follow",16316],
    "❤️ Likes Sin Drop 30 Días":                    ["❤️ LIKES GARANTÍA",       "1.000", 2.49, "ttk_likes", 18008],
    "❤️ Likes Sin Drop + Garantía":                 ["❤️ LIKES PREMIUM",        "1.000", 3.49, "ttk_likes", 18009],
    "❤️ Likes Sin Drop Instantáneos":               ["❤️ LIKES INSTANT",        "1.000", 1.99, "ttk_likes", 18010],
    "❤️ Likes Premium Sin Drop":                    ["❤️ LIKES ELITE",          "1.000", 4.49, "ttk_likes", 18011]
}

# 📘 FACEBOOK
FACEBOOK = {
    "👥 Seguidores Página/Perfil Rápido":            ["👥 SEGUIDORES RÁPIDO",    "1.000", 5.99, "fb_follow", 12238],
    "👥 Seguidores Página/Perfil Estable":           ["👥 SEGUIDORES ESTABLE",   "1.000", 6.99, "fb_follow", 8044],
    "👍 Reacciones Me Gusta":                        ["👍 REACCIONES MG",        "1.000", 2.99, "fb_reactions", 1461],
    "❤️ Reacciones Me Encanta":                      ["❤️ REACCIONES ME ENCANTA","1.000", 2.99, "fb_reactions", 655],
    "😲 Reacciones Guau":                            ["😲 REACCIONES GUAU",      "1.000", 2.99, "fb_reactions", 656],
    "🤗 Reacciones Me Importa":                      ["🤗 REACCIONES IMPORTAN",  "1.000", 2.99, "fb_reactions", 1459],
    "😂 Reacciones Jaja":                            ["😂 REACCIONES JA JA",     "1.000", 2.99, "fb_reactions", 657],
    "😢 Reacciones Triste":                          ["😢 REACCIONES TRISTE",    "1.000", 2.99, "fb_reactions", 658],
    "😠 Reacciones Enojado":                         ["😠 REACCIONES ENOJADO",   "1.000", 2.99, "fb_reactions", 659]
}

# 📺 YOUTUBE
YOUTUBE = {
    "❤️ Likes Casi Sin Caída [5K/Día]":             ["❤️ LIKES ESTABLES",       "1.000", 4.99, "yt_likes", 17855],
    "❤️ Likes Casi Sin Caída [10K/Día]":            ["❤️ LIKES VELOCES",        "1.000", 3.99, "yt_likes", 17856],
    "❤️ Likes + Recarga 30 Días":                   ["❤️ LIKES GARANTÍA 30D",   "1.000", 6.99, "yt_likes", 17857],
    "❤️ Likes Alta Velocidad Sin Recarga":          ["❤️ LIKES RÁPIDOS",        "1.000", 2.99, "yt_likes", 15956],
    "❤️ Likes Alta Velocidad + 30 Días":            ["❤️ LIKES + 30 DÍAS",      "1.000", 4.99, "yt_likes", 15957],
    "❤️ Likes Alta Velocidad + 60 Días":            ["❤️ LIKES + 60 DÍAS",      "1.000", 5.99, "yt_likes", 15958],
    "❤️ Likes Alta Velocidad + 90 Días":            ["❤️ LIKES + 90 DÍAS",      "1.000", 6.99, "yt_likes", 15959],
    "❤️ Likes Alta Velocidad + 1 Año":              ["❤️ LIKES + 1 AÑO",        "1.000", 9.99, "yt_likes", 15960],
    "❤️ Likes Alta Velocidad + Para Siempre":       ["❤️ LIKES PERMANENTES",    "1.000", 14.99, "yt_likes", 15961]
}

# ✈️ TELEGRAM
TELEGRAM = {
    "👥 Miembros Grupo/Canal 90 Días":              ["👥 MIEMBROS 90 DÍAS",     "1.000", 5.99, "tg_members", 9043],
    "⭐ Miembros Premium + Vistas 3 Días":           ["⭐ PREMIUM 3 DÍAS",       "1.000", 12.99,"tg_premium", 17705],
    "⭐ Miembros Premium + Vistas 7 Días":           ["⭐ PREMIUM 7 DÍAS",       "1.000", 19.99,"tg_premium", 17706],
    "⭐ Miembros Premium + Vistas 10 Días":          ["⭐ PREMIUM 10 DÍAS",      "1.000", 26.99,"tg_premium", 17707],
    "⭐ Miembros Premium + Vistas 15 Días":          ["⭐ PREMIUM 15 DÍAS",      "1.000", 34.99,"tg_premium", 17708],
    "⭐ Miembros Premium + Vistas 20 Días":          ["⭐ PREMIUM 20 DÍAS",      "1.000", 42.99,"tg_premium", 17709],
    "⭐ Miembros Premium + Vistas 25 Días":          ["⭐ PREMIUM 25 DÍAS",      "1.000", 49.99,"tg_premium", 17710],
    "⭐ Miembros Premium + Vistas 30 Días":          ["⭐ PREMIUM 30 DÍAS",      "1.000", 59.99,"tg_premium", 17711],
    "🤖 Bot Inicio Premium":                         ["🤖 BOT INICIO",           "100",   7.99, "tg_bot", 17715],
    "🤖 Bot Inicio Premium + Actividad":            ["🤖 BOT INICIO + ACTIVIDAD","100",  10.99, "tg_bot", 17716]
}

# 📂 DICCIONARIO PARA LLAMAR FÁCILMENTE
MENUS = {
    "instagram": INSTAGRAM,
    "tiktok": TIKTOK,
    "facebook": FACEBOOK,
